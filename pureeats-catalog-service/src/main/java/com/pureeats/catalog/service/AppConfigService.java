...
public class AppConfigService {
    ...
    private AppConfigAdminRequest mergeOntoExisting(AppConfigAdminRequest request, AppConfigAdminRequest existing) {
        return new AppConfigAdminRequest(
                ...
                request.cuisineCategorySectionEnabled() != null ? request.cuisineCategorySectionEnabled() : existing.cuisineCategorySectionEnabled(),
    ...
    private static AppConfigAdminRequest withDefaults(AppConfigAdminRequest config) {
        ...
        return new AppConfigAdminRequest(
                ...
                config.cuisineCategorySectionEnabled() != null ? config.cuisineCategorySectionEnabled() : d.cuisineCategorySectionEnabled(),
